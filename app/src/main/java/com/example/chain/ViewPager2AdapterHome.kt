...
class ViewPager2AdapterHome(fragmentActivity: FragmentActivity) : FragmentStateAdapter(fragmentActivity) {
    ...
    override fun createFragment(position: Int): Fragment {
        ...
        return when (fragmentList[position]) {
            FragmentName.WHITE -> StartFragment()
            FragmentName.RED -> GoalFragment()
            FragmentName.GREEN -> ReserveFragment()
        }
