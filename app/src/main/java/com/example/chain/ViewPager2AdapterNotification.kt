...
class ViewPager2AdapterNotification(fragmentActivity: FragmentActivity) : FragmentStateAdapter(fragmentActivity) {
    ...
    override fun createFragment(position: Int): Fragment {
        ...
        return when (fragmentList[position]) {
            FragmentName.WHITE -> FromSchoolFragment()
            FragmentName.RED -> FromChainFragment()
            FragmentName.GREEN -> UnknownFragment()
        }
